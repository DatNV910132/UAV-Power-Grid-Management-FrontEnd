...
public class VideoFeedView extends TextureView implements SurfaceTextureListener {
    ...
    /**
     * Instantiates a new Video feed view.
     *
...
//region Life-Cycle
    ...
    /**
     * Register live video video feeder . video data listener.
     *
     * @param videoFeed the video feed
     * @param isPrimary the is primary
     * @return the video feeder . video data listener
     */
//region Logic
