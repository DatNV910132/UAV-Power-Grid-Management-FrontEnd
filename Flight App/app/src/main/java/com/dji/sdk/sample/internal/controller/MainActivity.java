...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * On receive start full screen request.
     *
...
//region Event-Bus
    ...
    /**
     * On receive end full screen request.
     *
     * @param event the event
     */
    @Subscribe
    ...
    /**
     * The type Search query event.
     */
    public static class SearchQueryEvent {
        private final String query;

        /**
         * Instantiates a new Search query event.
         *
    ...
    /**
     * The type Request start full screen event.
     */
    public static class RequestStartFullScreenEvent {
    }

    /**
     * The type Request end full screen event.
     */
    public static class RequestEndFullScreenEvent {
    }

    /**
     * The type Connectivity change event.
     */
