...
/**
 * The type Audio recorder handler.
 */
public class AudioRecorderHandler {
    ...
    /**
     * Instantiates a new Audio recorder handler.
     *
     ...
     * Start record.
     *
     * @param audioRecordingCallback the audio recording callback
     */
    ...
    /**
     * Delete last record file boolean.
     *
     * @return the boolean
     */
    ...
    private class RecordTask extends AsyncTask<String, Integer, String> {
        ...
        /**
         * Instantiates a new Record task.
         *
         * @param audioRecordingCallback the audio recording callback
         */
    ...
    /**
     * The interface Audio recording callback.
     */
