...
public abstract class BaseThreeBtnView extends LinearLayout implements View.OnClickListener, PresentableView {
    ...
    /**
     * Instantiates a new Base three btn view.
     *
     ...
     * Change description.
     *
     * @param newDescriptionResID the new description res id
     */
    ...
    /**
     * Gets middle btn text resource id.
     *
    ...
    /**
     * Gets left btn text resource id.
     *
     * @return DISABLE to hide button
     */
    ...
    /**
     * Gets right btn text resource id.
     *
     * @return DISABLE to hide button
     */
